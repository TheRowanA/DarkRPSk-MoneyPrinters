...
local minPrint 			= 400							-- 	The minimum amount the printer can generate.
...
function ENT:Use(activator)
	if ( activator:IsPlayer() and self:GetNWInt("PrintA") >= 1 ) then
		...
		DarkRP.notify(activator, 0, 4, "You have collected $" .. self:GetNWInt("PrintA").. " from a Copper Printer." )
		self:SetNWInt("PrintA",0)
	end
end
